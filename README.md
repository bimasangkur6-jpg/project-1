...
A personal portfolio landing page built to demonstrate design and front-end development skills. Swiss/editorial-influenced design: black and white with a single red accent, bold display type, asymmetric layout. Plain HTML, CSS, and JavaScript, no framework.
